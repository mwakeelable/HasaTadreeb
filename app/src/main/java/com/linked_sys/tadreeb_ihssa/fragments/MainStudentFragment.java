...
public class MainStudentFragment extends Fragment {
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        view.findViewById(R.id.btnTraineeFinishedPrograms).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                activity.openActivity(StudentCertificatesActivity.class);
            }
        });
        view.findViewById(R.id.btnTraineeRecentPrograms).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                activity.openActivity(StudentCoursesActivity.class);
            }
        });
        view.findViewById(R.id.btnTraineeRegister).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
